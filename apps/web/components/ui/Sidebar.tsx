  ...
  return (
    <aside className="w-60 min-h-screen bg-white border-r border-gray-200 flex flex-col">
      ...
      <div className="flex items-center gap-3 px-4 py-4 border-b border-gray-200">
        ...
        <div>
          <p className="text-sm font-bold text-gray-900">Nexus ERP</p>
          <p className="text-xs text-gray-400 uppercase tracking-wide">Administración Central</p>
        </div>
      </div>
      ...
      <div className="px-4 py-4 border-t border-gray-200">
        <Link href="/profile" className="flex items-center gap-3 hover:bg-gray-50
